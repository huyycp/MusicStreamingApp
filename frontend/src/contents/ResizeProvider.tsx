...
export function ResizeProvider({ children }: { children: ReactNode }) {
  ...
  const minWidths: [number, number, number] = [72, 449, 248]
  ...
  return (
    <ResizeContext.Provider
      value={{ widths, setWidth, isBox2Visible, setIsBox2Visible, openList, setOpenList, setOpenMusic, openMusic, maxWidths, defaultWidths, minWidths }}
    >
      {children}
    </ResizeContext.Provider>
  )
